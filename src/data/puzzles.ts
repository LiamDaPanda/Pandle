...
export const ALL_PUZZLES: Puzzle[] = [
  ...
  // ===== Toy Chest (easy 5x5) =====
  { id: 'bell', name: 'Bell', icon: 'gift', difficulty: 'easy',
    width: 5, height: 5, grid: ['..Y..', '.YYY.', 'YYYYY', 'YYYYY', '..Y..'] },
  { id: 'bone', name: 'Bone', icon: 'panda', difficulty: 'easy',
    width: 5, height: 5, grid: ['WW.WW', 'WWWWW', '..W..', 'WWWWW', 'WW.WW'] },
  { id: 'hourglass', name: 'Hourglass', icon: 'gem', difficulty: 'easy',
    width: 5, height: 5, grid: ['NNNNN', '.NNN.', '..N..', '.NNN.', 'NNNNN'] },
  { id: 'arrow', name: 'Arrow', icon: 'star', difficulty: 'easy',
    width: 5, height: 5, grid: ['..G..', '.GGG.', 'GGGGG', '..G..', '..G..'] },
  { id: 'flag', name: 'Flag', icon: 'map', difficulty: 'easy',
    width: 5, height: 5, grid: ['RRRR.', 'RRRR.', 'RRRR.', 'N....', 'N....'] },
  { id: 'envelope', name: 'Letter', icon: 'gift', difficulty: 'easy',
    width: 5, height: 5, grid: ['RRRRR', 'RR.RR', 'R.R.R', 'RR.RR', 'RRRRR'] },

  // ===== Storybook Trail (medium/hard 10x10) =====
  { id: 'whale', name: 'Whale', icon: 'wave', difficulty: 'medium',
    width: 10, height: 10, grid: [
      '....W.....',
      '...WWW....',
      '.BBBB.....',
  ...
  { id: 'owl', name: 'Owl', icon: 'tree', difficulty: 'medium',
    width: 10, height: 10, grid: [
      '.NN....NN.',
      'NNNN..NNNN',
      'NNNNNNNNNN',
  ...
  { id: 'turtle', name: 'Turtle', icon: 'leaf', difficulty: 'medium',
    width: 10, height: 10, grid: [
      '....GG....',
      '..GGGGGG..',
      '.GGGGGGGG.',
  ...
  { id: 'snail', name: 'Snail', icon: 'clover', difficulty: 'hard',
    width: 10, height: 10, grid: [
      '..........',
      '...OOOO..O',
      '..OOOOOO.O',
  ...
  { id: 'crab', name: 'Crab', icon: 'fish', difficulty: 'hard',
    width: 10, height: 10, grid: [
      'R........R',
      'RR.RRRR.RR',
      '.RRRRRRRR.',
  ...
  { id: 'castle', name: 'Castle', icon: 'house', difficulty: 'hard',
    width: 10, height: 10, grid: [
      'S.S.SS.S.S',
      'SSSSSSSSSS',
      'SSSSSSSSSS',
